        ...
        >
          <div className="max-w-6xl w-full min-h-[80vh] p-10 bg-white shadow-xl rounded-xl">
            ...
            <Tabs defaultActiveKey="1" centered>
              {/* Project Details */}
              <TabPane
                tab={<span className="font-bold text-lg">Details</span>}
                key="1"
              >
                <div className="space-y-6 min-h-[60vh] flex flex-col justify-center">
                  ...
                  >
                    ...
                    <Option value="Sybase">
                      <Checkbox checked={selectedDatabases.includes("Sybase")} />{" "}
                      Sybase
                    </Option>
                  </Select>

                  <Button type="primary" className="w-full py-2 text-lg mt-auto">
                    Next
                  </Button>
                </div>
              </TabPane>
              ...
              {/* Upload Images */}
              <TabPane
                tab={<span className="font-bold text-lg">Upload Images</span>}
                key="2"
              >
                <div className="p-6 min-h-[60vh] flex flex-col justify-center">
                  ...
                  <Button
                    type="primary"
                    className="mt-6 w-full py-2 text-lg mt-auto"
                  >
                    Finish
                  </Button>
                </div>
